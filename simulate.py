...
# python3 simulate.py --data_dir ${PLINK_DIR} --chr_i ${chr_i} --var_g ${var_g} --var_e ${var_e} --out_dir ${cur_dir}/sim-out
def simulate(data_dir, chr_i, var_g, var_e, out_dir):
    """
    print("read in data dir: ", data_dir)
    print("read in chr num: ", chr_i)
    print("read in var g: ", var_g)
    print("read in var e: ", var_e)
    print("read in out dir: ", out_dir)
    """
    ...
    dset_admix = admix.io.read_plink(data_dir+"/admix/chr22"+str(chr_i))
